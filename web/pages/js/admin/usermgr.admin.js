...
function get_entry_info(id){
    ...
    table_output += '<label><input type="checkbox" value="0" name="entry_' + id + '">用户删除权</label>&nbsp;';
    table_output += '<label><input type="checkbox" value="64" name="entry_' + id + '">用户密码修改权</label>&nbsp;';
    table_output += '<label><input type="checkbox" value="0" name="entry_' + id + '">用户权限修改权</label>&nbsp;|&nbsp;';
    
    table_output += '<label><input type="checkbox" value="8" name="entry_' + id + '">页面注册权</label>&nbsp;';
    table_output += '<label><input type="checkbox" value="0" name="entry_' + id + '">页面删除权</label>&nbsp;';
    table_output += '<label><input type="checkbox" value="0" name="entry_' + id + '">页面信息修改权</label>&nbsp;|&nbsp;';
